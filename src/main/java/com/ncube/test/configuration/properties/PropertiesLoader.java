package com.ncube.test.configuration.properties;

import com.ncube.test.configuration.TestsConfig;
import com.ncube.test.exceptions.TestsConfigurationException;
...
/**
 * Class for loading base tests properties.
 * It gets properties - system or from file (by specified names) and sets it to fields of TestConfig object
 */
